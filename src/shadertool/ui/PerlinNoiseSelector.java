...
public class PerlinNoiseSelector extends JFrame {
	 ...
	 * Create the frame.
	 */
	public PerlinNoiseSelector(final PerlinNoiseNode node) {
		setTitle("Propiedades perlin");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 282, 260);
		...
		JLabel lblRepeticinHorizontal = new JLabel("Repetici\u00F3n horizontal:");
		JLabel lblRepeticinVertical = new JLabel("Repetici\u00F3n vertical:");
		JLabel lblOctavas = new JLabel("Octavas:");
		JLabel lblPersistencia = new JLabel("Persistencia:");
		
		final JSpinner spinnerRepX = new JSpinner();
		spinnerRepX.setModel(new SpinnerNumberModel(node.getRepX(), 0.0f, null, 0.0001f));	
		
		final JSpinner spinnerRepY = new JSpinner();
		spinnerRepY.setModel(new SpinnerNumberModel(node.getRepY(), 0.0f, null, 0.0001f));
			...
			public void actionPerformed(ActionEvent e) {
				try {
					node.setProperties(
							...
							((Float)spinnerRepX.getValue()).floatValue(),
							((Float)spinnerRepY.getValue()).floatValue(),
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(spinnerRepX, GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
								.addComponent(spinnerRepY, GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblRepeticinHorizontal)
						.addComponent(spinnerRepX, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblRepeticinVertical)
						.addComponent(spinnerRepY, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblOctavas)
