...
public class ScaleNode extends OperationNode implements UpdatedFunction, SizeInterface {
	...
	public ScaleNode() throws SlickException {
		super("Escala");
	...
	public void initialize() throws SlickException {
		actions.add(new AbstractAction("Cambiar tamaño") {
			...
			public void actionPerformed(ActionEvent arg0) {
				new SizeSelector(ScaleNode.this).setVisible(true);	
			}
		});
	}
